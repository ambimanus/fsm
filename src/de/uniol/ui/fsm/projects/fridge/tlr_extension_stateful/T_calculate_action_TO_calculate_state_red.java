...
public class T_calculate_action_TO_calculate_state_red extends TimerTransition {

	private TLR_extension_stateful ext;

	public T_calculate_action_TO_calculate_state_red(TLR_extension_stateful parent,
