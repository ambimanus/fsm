...
public class T_wait_restore_TO_idle_cooling extends TimerTransition {

	private TLR_extension_random ext;

	public T_wait_restore_TO_idle_cooling(TLR_extension_random parent,
	...
	public void action(Object... params) {
		ext.getBc().signal(BaseController.EV_COOLING,
				ext.getBc().getW_polling(), ext.getTDest());
	}
