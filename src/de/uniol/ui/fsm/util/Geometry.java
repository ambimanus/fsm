...
public final class Geometry {
	 ...
	 *         exactly on the line >0 if points on same side.
	 */
	public static int sameSide(int x0, int y0, int x1, int y1, int px0,
	 ...
	 */
	public static int findLineSegmentIntersection(Line l1, Line l2,
			double[] intersection) {
		return Geometry.findLineSegmentIntersection(l1.x1, l1.y1, l1.x2, l1.y2,
				l2.x1, l2.y1, l2.x2, l2.y2, intersection);
	}
